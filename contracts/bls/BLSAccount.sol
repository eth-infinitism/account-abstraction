 ...
 * Note that unlike the "standard" SampleAcct, this account can't be called directly
 * (normal SampleAcct uses its "signer" address as both the ecrecover signer, and as a legitimate
 * Ethereum sender address. Obviously, a BLS public is not a valid Ethereum sender address.)
 */
contract BLSAccount is SampleAcct, IBLSAccount {
