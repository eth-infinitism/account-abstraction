...
| `paymasterAndData`   | `bytes`   | concatenation of paymaster fields (or empty):<br/>paymaster address, paymasterVerificationGasLimit(16 byte), postOpGasLimit(16 bytes) and paymasterData(bytes) |
| `signature`          | `bytes`   |                                                                                                                                                                |
