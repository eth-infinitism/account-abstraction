...
But "global" entities - paymasters, deployers and aggregators are accessed by multiple UserOperations, and thus might influence them.
...
The only exemption from staking is if the entity doesn't use global storage
