...
| `preVerificationGas` | `uint256` | The amount of gas to compensate the bundler for pre-verification execution and sending userOp parameters like calldata, paymasterAndData and signature to blockchain |
