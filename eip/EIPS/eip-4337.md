...
We define all these storage slots as "associated with an address". You must explicitly use the given address to get them, and they cannot be associated with any other address.
