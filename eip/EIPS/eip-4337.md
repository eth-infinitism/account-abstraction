...
```c++
function handleOps
    (UserOperation[] calldata ops, address payable beneficiary, address aggregator, bytes aggregatedSignature)
    public;
...
* **getPublicKey()** is called by the aggregator, to get the wallet-specific public key.
