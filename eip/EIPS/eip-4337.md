...
4. The second (validatePaymasterUserOp), the paymaster may access storage slots of itself AND of the account, above. If it accesses global storage, not in the account or in a mapping keyed by the account, verify that the paymaster is staked.
