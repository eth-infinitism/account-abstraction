...
| `preVerificationGas` | `uint256` | The amount of gas to compensate the bundler for this UserOperation that cannot be calculated directly on-chain by EntryPoint's validation. To know more, [read here](#preverificationgas-field). |
