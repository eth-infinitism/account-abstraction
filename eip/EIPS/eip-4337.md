...
3. The second (validatePaymasterUserOp) call does not access _mutable state_ of any contract except the paymaster itself. The paymaster is also not allowed to make any state-change calls (SSTORE)
   A bundler MAY whitelist specific paymaster addresses, and not perform the above storage limitations
...
See [https://github.com/opengsn/account-abstraction/tree/main/contracts](https://github.com/opengsn/account-abstraction/tree/main/contracts)
